...
final class MemoryCacheTests: XCTestCase {
    ...
    func testSetAndGet() async {
        ...
        let cache = MemoryCache<String, String, LRUEvictionStrategy<String>>(
            maxSize: 2,
        ...
        XCTAssertEqual(result, "value1", "The cache should return 'value1' for 'key1'.")
    }
    ...
    func testEviction() async {
        ...
        XCTAssertEqual(result2, "value2", "The cache should still contain 'key2'.")
        XCTAssertEqual(result3, "value3", "The cache should contain 'key3'.")
    }
    ...
    func testEvictionAndAccessTracking() async {
        ...
        XCTAssertEqual(result1, "value1", "The cache should still contain 'key1'.")
